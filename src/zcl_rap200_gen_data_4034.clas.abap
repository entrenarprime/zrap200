CLASS zcl_rap200_gen_data_4034 DEFINITION
  PUBLIC
  FINAL
  CREATE PUBLIC .
...
CLASS zcl_rap200_gen_data_4034 IMPLEMENTATION.
...
*   clear data
    ...
    COMMIT WORK.
    out->write( |[RAP200] Demo data generated for table ZRAP200_ATRAV{ group_id }. | ).
